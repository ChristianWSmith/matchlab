...
optimize:
  ...
  bo:                           # optional, Bayesian optimization settings
    ...
    batch_size: <usize>         #   optional, batch evaluation size (default: num_cpus via --batch-size CLI flag; 1 = sequential; >1 enables async parallel evaluation, non-deterministic trajectory)
