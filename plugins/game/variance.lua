-- plugins/game/variance.lua
-- Logistic outcome with a variance_multiplier-scaled noise envelope: more
...
function simulate(match_id, team_a, team_b, config, context)
    ...
    local noise = matchlab.rng_range(-config.noise, config.noise) * config.variance_multiplier
